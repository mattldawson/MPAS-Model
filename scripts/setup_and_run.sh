...
step "Step 1/8: Build chempas-dev container image"
...
step "Step 2/8: Fetch physics externals"
...
# ---------- Step 3: Build MPAS -----------------------------------------------
step "Step 3/8: Build MPAS-A (atmosphere + init_atmosphere)"
...
step "Step 4/8: Download 480-km mesh"
