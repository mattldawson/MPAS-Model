...
step "Step 1/9: Build chempas-dev container image"
...
step "Step 2/9: Fetch physics externals"
...
# ---------- Step 3: Build MPAS -----------------------------------------------
step "Step 3/9: Build MPAS-A (atmosphere + init_atmosphere)"
...
step "Step 4/9: Download 480-km mesh"
...
ls -lh data/jw_480km_chapman/output.nc data/jw_480km_analytical/output.nc \
       ...
       data/jw_480km_ts1_cloud/output.nc
echo ""
